...
class AmazingGameEnv(gym.Env):
    def __init__(self):
        ...
        self.cube = {"x": random.randint(10, self.SCREEN_WIDTH -10 ), "y": 600, "size": 20, "speed": 0, "gravity": 350, "jump": -250, "xSpeed": 0}
    ...
    def reset(self):
        self.cube["x"] = random.randint(10, self.SCREEN_WIDTH -10 )
        self.cube["y"] = 400
        self.cube["speed"] = 0
        self.cube["xSpeed"] = 0
        self.camera["y"] = 0
