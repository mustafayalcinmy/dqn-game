...
class AmazingGameEnv(gym.Env):
    def __init__(self):
        ...
        self.cube = {"x": random.randint(0, self.SCREEN_WIDTH), "y": 300, "size": 20, "speed": 0, "gravity": 300, "jump": -150, "xSpeed": 0}
    ...
    def get_state(self) -> np.ndarray:
        return np.array([self.cube["x"], self.cube["y"] - self.camera["y"] , self.currentGap["x"] + (self.gapWidth / 2) , self.currentGap["y"] - self.camera["y"]], dtype=np.float32)
