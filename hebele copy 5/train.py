...
# Hyperparameters
episodes = 3000
min_exploration_episodes = 1000  # Minimum number of episodes with full exploration
max_decay_episodes = 1900  # Episodes over which epsilon decays to epsilon_min
render = False
save_interval = 100
